...
This is the website for the Organic Store in Birr: [ORGANIC STORE](https://troeske.github.io/OrganicStore/index.html). The store is focussing on selling the best organic products from groceries to organic soaps and coffee, sourced locally wherever possible. It is located in the town Birr in Offerlay, Ireland.  
...
## Design
### Site Structure
The site implements a simple strcuture with the main lanmding page and three sub-sites for product details, the lunch menue and about us: 
...
To provide the user with a one-click option regarldess of where they are on the site to see the __Opening Hours__, the __Contact Details__ as well as open a Google Maps Page with __Directions to the Store__, the site gfeatures a Floating Navigation Bar that is always visible and accessible to the user.
...
As a quick visual apealing overview of what products the store carries as well as as a quick secondery Navigation Bar, the landing page features clickable buttons.
...
To draw customers into the store and showcase the big variaty of what the store has to offer the landing page displays current Special Offers in a slidable carousel implementation.
...
To get users to register the sitze features a sign-up form as part of the about sub site.

![Newsletter Sign-Up Form](media/subscribe-to-newsletter-mobile.png)

- __Social Media Icons/Link__
The Organic Store has a great presence on Instagramm and facebook. Both social media platforms a accessable through icons and respective links in the footer of each page.
...
| Drop Down Menu | click on hanburger menu | Hamburger menue opens | ok |
| Menu-Item: Products | click on Products in hamburger menu | Product page opens | ok |
| Menu-Item: Lunch | click on Lunch in hamburger menu | Lunch Menue page opens | ok |
...
| Floating Nav Bar | click on openening hours icon | Slide out apears showing the opening hours of the store | ok |
...
| Special Offers Carousel | thumb slide throught the available Offers | Offers carousel shows the next special offer | ok |
| Special Offers Carousel | click/tab the '<previous>' '<next>' button below offer cards to go throught the available Offers | Offers carousel shows the next special offer | ok |
| Footer | Click on the social media icons | Jump to the facbook or Instagram page of the Organic Store | ok |
...
| Newsletter Input Validation | Click on 'Subscribe' with no input on First Name | Info apears to fill out the field and submit is blocked| ok |
| Newsletter Input Validation | Click on 'Subscribe' with no input on Last Name | Info apears to fill out the field and submit is blocked| ok |
| Newsletter Input Validation | Click on 'Subscribe' with no input on eMail | Info apears to fill out the field and submit is blocked| ok |
| Newsletter Input Validation | Click on 'Subscribe' with no @ in the eMail field  | Info apears to provide an @ in this field and submit is blocked| ok |
| Hero Video in About Page - android | scroll to video | video is autoplaying | ok |
| Hero Video in About Page - iOS | scroll to video | video is autoplaying | fail |
| Hero Video in About Page - desktop | scroll to video | video is autoplaying | ok |
| external links on landing page | click on external link | external link opens in seperate tab | ok |
| external links on products page | click on external link | external link opens in seperate tab | ok |
| external links on about page | click on external link | external link opens in seperate tab | ok |
